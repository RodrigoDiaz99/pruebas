...
<html lang="en">
    ...
    <body id="page-top">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                            ...
                            @if (Route::has('login'))
                                <div class="flex-center position-ref full-height">
                                    @auth
                                    <a class="nav-link js-scroll-trigger" href="{{ url('/principal') }}">Home</a>

                                    @else
                                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="{{ route('login2') }}">Acceso</a></li>
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2020 - Carmen Andrea Reyes Reyes</div></div>
        </footer>
        <!-- Bootstrap core JS-->
